...
function EgressDetails() {
  ...
  useEffect(() => {
    const allFilteredExpenses = (filters) => {
      return allExpenses
        .filter((item) => {
    ...
    async function getFilteredData() {
      ...
      const filteredData = allFilteredExpenses({
  ...
  const handleDeleteExpense = async (id) => {
    ...
    setAllExpenses((prevState) =>
      prevState.filter((expense) => expense.idEgress !== id),
    );

    setUserData((prevState) => {
      const expenseAmount = expenses.find((e) => e.idEgress === id).amount;
      return {
        ...prevState,
        totalIncome: prevState.totalIncome + expenseAmount,
      };
    });
