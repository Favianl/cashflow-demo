...
function SavingsManager() {
  ...
  const { updateSaving, delSaving, userData, setUserData } = useUser(); //traigo el contexto user
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    const newAmount = userData.accumulatedSavings + parseFloat(data.amount);

    setUserData((preState) => {
      const newUserData = {
        ...preState,
        accumulatedSavings: newAmount,
      };
      return newUserData;
    });
